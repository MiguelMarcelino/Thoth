...
Kubectl is a command line tool for communicating with a [Kubernetes](cloud/deployment/kubernetes/kubernetes.md) cluster's control plane, using the Kubernetes API.
